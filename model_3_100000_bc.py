# Deze file gebruikt model 3 met de voldedige Dataset, binary_crossentropy en activation layer softmax
...
# Verwijderen van de stopwoorden in de datasets
...
# Woorden index maken van de overgebeleven woordens
